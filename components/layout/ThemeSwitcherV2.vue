<template>
    <div>
      <div v-if="dark">
        <button class="ThemeSwitcher-btn" @click="toggle">
          <!--               <img width="30px" src="/public/img/svg/sunny-filled-loop-to-moon-filled-loop-transition.svg" alt="Discover Nuxt 3" />
   -->
   <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24">
            ...
            <circle cx="12" cy="12" r="10" fill="currentColor" mask="url(#lineMdMoonFilledToSunnyFilledLoopTransition0)"
              opacity="0">
      ...
      <div v-else>
        <button class="ThemeSwitcher-btn" @click="toggle">
          <!--         <img width="30px" src="/public/img/svg/moon-filled-to-sunny-filled-loop-transition.svg" alt="Discover Nuxt 3" />
   -->
